...
function Student(name, major, yearInSchool, club) {
  ...
  function sortArr(comparator, array) {
    for(var i = 0; i < array.length - 1; i++){
        ...
        (comparator(array[j], array[j + 1]))? "" : swap(array, j);
        }
        var sorted_Arr = [];
        var p = 0;
        for(var i in array){
        sorted_Arr[p] = array[i];
        p++;
        }
        return sorted_Arr;
    }
  ...
  function majorComparator(student1, student2) {
    return exComparator(student1.major.toLowerCase(), student2.major.toLowerCase())? false : true;
  }
  ...
  function clubComparator(student1, student2) {
    return exComparator(student1.club.toLowerCase(), student2.club.toLowerCase())? false : true;
  }
  
//LogMe function to display objects 
...
function printOut(array, clubPresent){
    // this function takes the object array and calls logMe to print
    for (i = 0; i < array.length; i++){
        array[i].logMe(clubPresent);
    }
}
...
var result_year_in_school = sortArr(yearComparator, students);
printOut(result_year_in_school, false);
...
console.log("(Name - Major - Year) // of the \"greatest\" student")
var result_major = sortArr(majorComparator, students);
printOut(result_major, false);
console.log("(Name - Major - Year) // of the \"least\" student");
console.log("");
...
console.log("(Name - Major - Year) // of the \"greatest\" student")
var result_club = sortArr(clubComparator, students);
printOut(result_club, true);
console.log("(Name - Major - Year) // of the \"least\" student");
console.log("");
console.log("**********");
